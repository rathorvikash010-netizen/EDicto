...
export default function UnifiedWordCard({ word, variant = 'explore', daysLeft, className = '' }) {
  ...
  // Open the detail modal on card click
  const handleCardClick = (e) => {
    // Don't open modal if user clicked a button or link inside the card
  ...
  return (
    <>
      ...
      {/* Detail Modal */}
      {showModal && (
        <WordDetailModal word={word} onClose={() => setShowModal(false)} />
      )}
    </>
  );
}
